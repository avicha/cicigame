...
//背景
            this.bg1 = this.addGameObject(new Background(0, 0, Layer.Background, Background.Textures.bg1, {speed:new Vector2(120, 0), repeat:true, distance:2}));

            this.bg2 = this.addGameObject(new Background(0, 0, Layer.Foreground, Background.Textures.bg2, {speed:new Vector2(120, 0), repeat:true, distance:1}));
//头像背景
        ...
        update:function () {
            ...
            if (r < 0.3 / YI.fps) {
                ...
                if (r < 0.1 / YI.fps) {
                    ...
                    var dog = this.addGameObject(new Dog1(YI.width, 500, this.dogs.length + 5));

                    this.dogs.push(dog);
                } else {
                    if (r < 0.2 / YI.fps) {
                        var dog = this.addGameObject(new Dog2(YI.width, 500, this.dogs.length + 5));

                        this.dogs.push(dog);
                    } else {

                        var dog = this.addGameObject(new Dog3(YI.width, 450, this.dogs.length + 5));
